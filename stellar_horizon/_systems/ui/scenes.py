...
from stellar_horizon._systems.core.scene_manager import GameState, Scene
from stellar_horizon._systems.core.settings import INTERNAL_H, INTERNAL_W
from stellar_horizon._systems.utils.palette import PALETTE
...
class TitleScene(Scene):
    ...
    def on_enter(self) -> None:
        ...
        from stellar_horizon._systems.audio import music
...
class GameplayScene(Scene):
    ...
    def __init__(self, transition_to: "TransitionFn", act: int = 1,
        ...
        from stellar_horizon._systems.ui.gameplay_runtime import GameplayRuntime
