...
if TYPE_CHECKING:  # avoid runtime import cycles
    from stellar_horizon._systems.systems.bezier_path import BezierPath
from enum import Enum

import pygame

from stellar_horizon._systems.core.settings import INTERNAL_H, INTERNAL_W
from stellar_horizon._systems.systems.pool import Pool
...
class Boss:
    ...
    def update(self, dt: float) -> None:
        ...
        # BLOQUE 58.13.1: restored sin oscillation that BLOQUE 58.59 broke —
        # without it, the boss sat frozen at the anchor (no movement, no
        # move_t advance → RNG attack selection stuck on one type forever,
        # GOLIATH never threw the spear).
