...
class Player:
    ...
    def add_gold_ring(self) -> int:
        ...
        """
        from stellar_horizon._systems.core.settings import GOLD_RING_HEAL, PLAYER_HP_ABSOLUTE_MAX
    ...
    def add_tech_upgrade(self, upgrade_id: str) -> None:
        ...
        """
        from stellar_horizon._systems.core.settings import TECH_HP_BOOST_PCT, PLAYER_HP_ABSOLUTE_MAX
