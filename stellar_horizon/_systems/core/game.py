...
from stellar_horizon._systems.core.scene_manager import (
    GameState,
    Scene,
    SceneManager,
    StateError,
...
from stellar_horizon._systems.ui.scenes import (
    ActClearedScene,
    ActIntroScene,
    BossFightScene,
    BossIntroScene,
...
class Game:
    ...
    def __init__(self, easy: bool = False) -> None:
        ...
        import os as _os
        from stellar_horizon._systems.core.settings import INTERNAL_W as _IW, INTERNAL_H as _IH
