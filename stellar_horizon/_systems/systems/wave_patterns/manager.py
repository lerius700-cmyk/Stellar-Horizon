...
from stellar_horizon._systems.systems.wave_patterns.bezier_sweep import BezierSweepPattern
from stellar_horizon._systems.systems.wave_patterns.v_formation import VFormationPattern
from stellar_horizon._systems.systems.wave_patterns.leader_chain import LeaderFollowerChainPattern
from stellar_horizon._systems.systems.wave_patterns.dice_grid import DiceFiveGridPattern
from stellar_horizon._systems.systems.wave_patterns.pincer_cross import PincerCrossPattern
from stellar_horizon._systems.systems.wave_patterns.oscillating_butterfly import OscillatingButterflyPattern
...
class ProceduralWaveManager:
    ...
    def register_composed_patterns(self) -> int:
        ...
        """
        from stellar_horizon._systems.systems.wave_patterns.composed import COMPOSED_PATTERNS
