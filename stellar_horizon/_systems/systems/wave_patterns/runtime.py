...
from stellar_horizon._systems.entities.enemies.enemy import Enemy, EnemyKind, EnemyPool
from stellar_horizon._systems.movement.bezier import BezierPath, Point
from stellar_horizon._systems.movement.waypoint import WaypointPath
from stellar_horizon._systems.movement.follower import PathFollower
from stellar_horizon._systems.movement.parallel_path import ParallelPathPair
from stellar_horizon._systems.movement.orbital_path import OrbitalPath
from stellar_horizon._systems.systems.wave_patterns.base import (
    WavePatternResult,
    SpawnedShip,
    WavePatternKind,
)
...
def spawn_pattern_wave(
    ...
    for spawned in result.ships:
        ...
        if "p0" in spawned.extra:
            ...
            from stellar_horizon._systems.systems.wave_patterns.runtime import attach_parallel_pair_path
            ...
            from stellar_horizon._systems.systems.wave_patterns.runtime import attach_orbital_path
            attach_orbital_path(
                e,
