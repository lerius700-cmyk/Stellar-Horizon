"""Create GitHub release v1.4.0 with the .zip asset.

Usage: python tools/create_v1_4_0_release.py
"""
import os
import sys
...
def main(argv: list[str]) -> int:
    ...
    notes_path = repo_root / "RELEASE_NOTES_v1.4.0.md"
    zip_path = repo_root / "releases" / "StellarHorizon-v1.4.0-win64.zip"
